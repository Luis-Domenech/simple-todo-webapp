...
type FormikFileInputState = 'setting_up' | 'waiting_for_key' | 'getting_signed_url' | 'uploading' | 'ready'

const Base: React.FC<FormikFileInputProps & InputProps> = (props) => {
  const {
    eprops = {},
    file_folder,
    id,
  ...
  // State Variables
  const [state, setState] = useState<FormikFileInputState>('getting_signed_url')
...
export const FormikFileInput = chakra(Base, {
